...
// Extendemos el controlador original de Voyager
use TCG\Voyager\Http\Controllers\VoyagerBaseController as BaseVoyagerBaseController;

use App\Http\Controllers\StorageController;
// Dependencias necesarias para los métodos que vamos a sobreescribir y añadir
...
class Controller extends BaseVoyagerBaseController
{
    // -------------------------------------------------------------------------
    // MÉTODOS SOBREESCRITOS DE VOYAGER
    // Hemos copiado estos métodos desde la clase base de Voyager para poder
    // modificarlos y añadir tu lógica personalizada de guardado de imágenes.
    // -------------------------------------------------------------------------

    /**
     * Copiado de TCG\Voyager\Http\Controllers\Controller
     * Este método es el responsable de procesar y guardar los datos de un BREAD.
     * No lo modificamos, pero lo necesitamos aquí para que llame a nuestro
     * getContentBasedOnType() modificado.
     */
    ...
    /**
     * Copiado de TCG\Voyager\Http\Controllers\Controller y MODIFICADO.
     * Aquí es donde interceptamos el tipo 'image' y llamamos a tu
     * método personalizado store_image().
     */
