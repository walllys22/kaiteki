...
- **En celular la hoja va a pantalla completa** (`max-width: 700px`): sin padding del body, sin bordes ni sombra, `min-height: 100svh` y el pie empujado con `margin-top: auto` para que la varilla inferior apoye en el fondo. Como tarjeta flotante se veia chica y desaprovechaba el ancho. Lo mismo aplica a `invalido.blade.php`.
